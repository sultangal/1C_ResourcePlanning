//TODO: Проверить даты в интервалах что они входят в диапазон дат проекта
...
Процедура ИнтервалыЗанятостиСотрудниковПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	...
	//TODO: Сделать проверку интервалов на пересечения друг с другом
	КонецЕсли;
	ОбновитьТочкиИИнтервалы();
КонецПроцедуры
...
Процедура ИнтервалыЗанятостиСотрудниковНачалоИнтервалаПриИзменении(Элемент)
	...
	Если НачалоИнтервала = Дата('00010101') Тогда
		Возврат;
	КонецЕсли;
...
Процедура ИнтервалыЗанятостиСотрудниковКонецИнтервалаПриИзменении(Элемент)
	...
	Если КонецИнтервала = Дата('00010101') Тогда
		Возврат;
	КонецЕсли;
