...
Процедура ИнтервалыЗанятостиСотрудниковНачалоИнтервалаПриИзменении(Элемент)
	...
	Если НачалоИнтервала = Дата('00010101') ИЛИ 
			Элементы.ИнтервалыЗанятостиСотрудников.ТекущиеДанные.КонецИнтервала = Дата('00010101') Тогда
		Возврат;
	КонецЕсли;
	Если НачалоИнтервала < Объект.ДатаНачала Тогда
		...
		Элементы.ИнтервалыЗанятостиСотрудников.ТекущиеДанные.НачалоИнтервала = Дата('00010101');
	КонецЕсли;
...
Процедура ИнтервалыЗанятостиСотрудниковКонецИнтервалаПриИзменении(Элемент)
	...
	Если КонецИнтервала = Дата('00010101') ИЛИ 
			Элементы.ИнтервалыЗанятостиСотрудников.ТекущиеДанные.НачалоИнтервала = Дата('00010101') Тогда
		Возврат;
	КонецЕсли;
	Если КонецИнтервала > Объект.ДатаОкончания Тогда
		...
		Элементы.ИнтервалыЗанятостиСотрудников.ТекущиеДанные.КонецИнтервала = Дата('00010101');
		Возврат;
	КонецЕсли;
