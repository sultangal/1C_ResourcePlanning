...
Процедура КомандаПроектаПриАктивизацииСтроки(Элемент)	
	Элементы.ИнтервалыЗанятостиСотрудников.ОтборСтрок = 
		Новый ФиксированнаяСтруктура("ИД", Элементы.КомандаПроекта.ТекущиеДанные.ИД);
КонецПроцедуры
#КонецОбласти
&НаКлиенте
Процедура ИнтервалыЗанятостиСотрудниковПриНачалеРедактирования(Элемент, НоваяСтрока, Копирование)
	//Проверяем если добавляется новая запись
	Если НоваяСтрока И Не Копирование Тогда
		Элементы.ИнтервалыЗанятостиСотрудников.ТекущиеДанные.ИД = 
